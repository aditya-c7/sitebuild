...
export const BANK: BankEntry[] = [
  ...
  },
  {
    ...
    reply: "His core stack: Advanced Python (Pandas, NumPy, Pydantic, OOP), JavaScript, TypeScript, SQL, FastAPI, Node.js, React, MongoDB, Firebase, plus RAG architectures, multi-agent orchestration (CrewAI, AutoGen), Linux, CI/CD, Playwright, and Vercel.",
    followups: ["What is his experience?", "What projects has he built?"],
    action: null,
  },
  {
