...
// Official Playwright "masks" mark (Streamline SVG Logos set).
// Fixed brand fills are kept so the icon renders in authentic
// Playwright green/red/navy at any size.
export function PlaywrightStreamline({ className }: { className?: string }) {
  return (
